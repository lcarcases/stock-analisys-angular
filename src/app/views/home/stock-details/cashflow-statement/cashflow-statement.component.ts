...
export class CashflowStatementComponent implements OnInit, DoCheck, OnDestroy {
  ...
  ngDoCheck() {
    if(window.innerWidth > 375 && window.innerWidth <= 900) {
      ...
      this.responsiveDimentions.marginTop = '2rem';
    }
    console.log("Se va a renderizar la vista cashflow statement");
  }
  ...
  getActiveColumns(stocksData) {
    ...
    for(let i = 0; i < ratiosByFiscalPeriod.length; i++) {
        ...
        /*eaderColumn.headerName = headerName;
